      ...
      >
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-headline text-2xl font-bold text-[#f0f2f8]">Create your account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Company URL */}
            <div>
              <label className="block text-[#8b95b0] text-sm font-medium mb-1.5">Company URL</label>
              <div className="relative">
